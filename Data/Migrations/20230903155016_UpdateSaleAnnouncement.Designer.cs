...
namespace AutoDealer.Data.Migrations
{
    ...
    [Migration("20230903155016_UpdateSaleAnnouncement")]
    partial class UpdateSaleAnnouncement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AutoDealer.Entities.Models.Auto.Generation", b =>
                {
                    b.HasOne("AutoDealer.Entities.Models.Auto.Model", "Model")
                        .WithOne("Generation")
                        .HasForeignKey("AutoDealer.Entities.Models.Auto.Generation", "ModelId")
